...
@column cell_type_count         Integer, number of cell types in which this feature is active
...
@column display_label   Short display label, intended for track legends on the website.
@column description     Free text description, used in the z-menu that appears when hovering over the cell type name
@column gender          Gender i.e. 'male', 'female', 'hermaphrodite' or 'mixed'
@column efo_id          Experimental Factor Ontology ID, currently under construction, not used anywhere.
